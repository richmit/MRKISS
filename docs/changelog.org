...
:END:
  ...
  - API breaking Changes
    - print_solution: Default for prt_titles_o changed from .TRUE. to .NOT. append_o.
  - Deprecated functionality
    - N/A
  - New functionality
    - mrkiss_erk_nystrom_5.f90
  - Documentation
    - Changed \par to @par in Doxygen comments.
    - Updated index.org RK methods tables.
    - Added stability region images to doxygen
  - Examples
    - New
      - step_too_small.f90
    - Updated
  ...
  - Tests
    - New
      - N/A
    - Updated
      - tc_make_make.rb now removes test case selector lines that don't match.
  - Miscellaneous
    - Added stability region and order star graphs to maple worksheets
