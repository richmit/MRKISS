...
[[https://github.com/richmit/MRKISS][~MRKISS~]] while the [[https://github.com/richmit/MRKISS/blob/master/examples][~examples/~]] directory contains code I
...
[[https://github.com/richmit/MRKISS][~MRKISS~]] is a little bit slippery.  Some of the tests, like ~tc1_*~ and ~tc2_*~, could be considered
...
[[https://github.com/richmit/MRKISS/blob/master/examples][~examples/~]] have numerous additional targets to run various individual tests or subsets of the
...
three tests corresponding to these hand written solvers:
  ...
  - ~test_dp54~ Runs the following tests
    ...
    - ~test_dp54_archive~ Test new output with archived output in [[https://github.com/richmit/MRKISS/blob/master/tests/data][~data/~]].
  - ~test_rkf45~ Runs the following tests
    ...
    - ~test_rkf45_archive~ Test new output with archived output in [[https://github.com/richmit/MRKISS/blob/master/tests/data][~data/~]].
  - ~test_rk4~ Runs the following tests
    ...
    - ~test_rk4_archive~ Test new output with archived output in [[https://github.com/richmit/MRKISS/blob/master/tests/data][~data/~]].
