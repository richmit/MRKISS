...
truncation error dominates the distribution is very tight and symmetric about the mean.  The round-off errors are quite different in that they have a much
higher variance.
