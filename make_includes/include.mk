...
mrkiss_eerk_verner_8_7$(OBJ_SUFFIX) mrkiss_eerk_verner_8_7.mod &: $(MRKISS_PATH)/lib/mrkiss_eerk_verner_8_7.f90 mrkiss_config.mod
	rm -f $(basename $@)$(OBJ_SUFFIX) $(basename $@).mod
	$(FC) $(FFLAGS) -c $< -o $(basename $@)$(OBJ_SUFFIX)

mrkiss_eerk_verner_7_6$(OBJ_SUFFIX) mrkiss_eerk_verner_7_6.mod &: $(MRKISS_PATH)/lib/mrkiss_eerk_verner_7_6.f90 mrkiss_config.mod
	rm -f $(basename $@)$(OBJ_SUFFIX) $(basename $@).mod
	$(FC) $(FFLAGS) -c $< -o $(basename $@)$(OBJ_SUFFIX)
